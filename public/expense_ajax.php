<?php
    /**
     *  expense_ajax.php
     *  transactions tab - renders a table using ajax with the category 'expense'
     */
	...
	if($_SERVER["REQUEST_METHOD"] == "GET")
	{
	    ...
	    $allIncome = [];
	    $getIncome = query("SELECT * FROM `transactions` WHERE `id` = ? AND `trans_category` = 'expense'", $_SESSION["id"] );
